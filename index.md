# shinipsum ![](https://raw.githubusercontent.com/ThinkR-open/shinipsum/master/img/thinkr-hex-shinipsum.png)

The goal of [shinipsum](https://github.com/Thinkr-open/shinipsum)is to
provide random shiny elements for easiest shiny app prototyping, so that
you can focus on building the frontend before building the backend.
...
You can run [shinipsum](https://github.com/Thinkr-open/shinipsum) demos
with:
...
- `...`: arguments which are passed to the
  [`dygraph()`](https://rdrr.io/pkg/dygraphs/man/dygraph.html) function.
...
[shinipsum](https://github.com/Thinkr-open/shinipsum) to generate a
random app:
...
![](https://raw.githubusercontent.com/ThinkR-open/shinipsum/master/img/shinipsum.png)

Please note that the ‘shinipsum’ project is released with a [Contributor
Code of
Conduct](https://thinkr-open.github.io/shinipsum/CODE_OF_CONDUCT.md). By
