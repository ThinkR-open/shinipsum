...
> Note: {shinipsum} only imports functions which are necessary to its internal job. If you want to customise an output or to use a renderXX / XXOutput, you'll need to explicitely load the packages needed (for example, if you want to customise a dygraph, a ggplot, or use ggplotly).
