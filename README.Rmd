...
[![Travis build status](https://travis-ci.org/ThinkR-open/shinipsum.svg?branch=master)](https://travis-ci.org/ThinkR-open/shinipsum)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/ThinkR-open/shinipsum?branch=master&svg=true)](https://ci.appveyor.com/project/ThinkR-open/shinipsum)
